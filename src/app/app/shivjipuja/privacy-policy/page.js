...
export const metadata = {
    title: 'Privacy Policy | Shiv Ji Puja',
    description: 'Privacy Policy for Shiv Ji Puja application.',
    robots: {
        index: true,
        follow: true,
    }
        ...
        <main className="min-h-screen bg-white text-slate-900 py-16 px-6 sm:px-12">
            <div className="max-w-3xl mx-auto">
                <header className="mb-12 border-b border-slate-200 pb-8">
                    <h1 className="text-3xl font-bold mb-2">Privacy Policy for Shiv Ji Puja</h1>
                ...
                <div className="space-y-8 leading-relaxed">
                    <section>
                        <p>
                            <strong>Axom IT Lab</strong> ("we", "us", or "our") operates the <strong>Shiv Ji Puja</strong> mobile application (the "Service").
                        </p>
                        <p className="mt-4">
