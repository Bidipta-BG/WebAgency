...
export const metadata = {
    ...
    description: 'Privacy Policy for Shri Krishna: Daily Puja Aarti application.',
    robots: {
        index: true,
        follow: true,
    }
        ...
        <main className="min-h-screen bg-white text-slate-900 py-16 px-6 sm:px-12">
            <div className="max-w-3xl mx-auto">
                <header className="mb-12 border-b border-slate-200 pb-8">
                    <h1 className="text-3xl font-bold mb-2">Privacy Policy for Shri Krishna: Daily Puja Aarti</h1>
