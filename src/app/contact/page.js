                    ...
                    <div>
                        ...
                        <div className="mt-16 pt-8 border-t border-surface-highlight">
                            <div className="flex gap-4">
                                <a href="#" className="w-12 h-12 rounded-full bg-surface-muted flex items-center justify-center text-slate-400 hover:text-white hover:bg-accent transition-all">
